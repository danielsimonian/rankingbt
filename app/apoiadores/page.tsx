...
const professores = [
  ...
  },
  {
    id: '2',
    nome: 'Professor João',
    foto: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Joao&backgroundColor=3b82f6',
    cidade: 'Guarujá',
    telefone: '(13) 98888-8888',
    whatsapp: '5513988888888',
    instagram: '@profjoao',
    especialidade: 'Alto Rendimento',
  },
  {
    id: '3',
    nome: 'Professora Carol',
    foto: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Carol&backgroundColor=ec4899',
    cidade: 'Praia Grande',
    telefone: '(13) 97777-7777',
    whatsapp: '5513977777777',
    instagram: '@profcarol',
    especialidade: 'Infantil e Juvenil',
  },
];
...
const points = [
  ...
  {
    id: '2',
    nome: 'Beach Point Guarujá',
    logo: 'https://api.dicebear.com/7.x/shapes/svg?seed=Beach&backgroundColor=3b82f6',
    endereco: 'Rua das Quadras, 456',
    cidade: 'Guarujá',
    telefone: '(13) 3222-2222',
    whatsapp: '5513322222222',
    instagram: '@beachpoint',
    site: 'https://beachpoint.com.br',
  },
  {
    id: '3',
